...
/*$(window).scroll(function(){
  var scrollvar = $(this).scrollTop(); // it wil return scoll var
  $("div.excerpttxt").css("transform",'translate(0px,-'+scrollvar/2+'%)');
  $("img.inspace-10.borderedbox.king").css("transform",'translate(-50%,'+scrollvar/3+'%)');
